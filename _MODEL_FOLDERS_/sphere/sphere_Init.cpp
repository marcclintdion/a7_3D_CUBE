        ...
        #ifdef __APPLE__                                                                                                                                   
        //---------------                                                                                                                                  
        filePathName = [[NSBundle mainBundle] pathForResource:@"sphere_DOT3.png"];                                           
        if(filePathName != nil)                                                                                                                                
        {                                                                                                                                                  
        ...
        //------------------------------------------------------------------------------------------------------------                                       
        //====================================================================================   
        sphere_boundingBox[0] = -1;
        sphere_boundingBox[1] = 1;
        sphere_boundingBox[2] = -1;
        sphere_boundingBox[3] = 1;
        sphere_boundingBox[4] = -1;
        sphere_boundingBox[5] = 1;
        //====================================================================================   
