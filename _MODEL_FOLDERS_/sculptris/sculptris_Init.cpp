      ...
      filePathName = [[NSBundle mainBundle] pathForResource:@"sculptris_DOT3" ofType:@"png"];                                                  
      ...
      //------------------------------------------------------------------------------------------                                              
      #ifdef WIN32                                                                                                                            
      loadTexture("_MODEL_FOLDERS_/sculptris/sculptris_DOT3.png",          sculptris_NORMALMAP);                                                      
