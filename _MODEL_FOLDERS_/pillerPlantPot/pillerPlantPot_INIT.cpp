      //------------------------------------------------------------------------------------------                                                       
      #ifdef __APPLE__                                                                                                                                   
      filePathName = [[NSBundle mainBundle] pathForResource:@"pillerPlantPot_DOT3" ofType:@"png"];                                           
      ...
      //------------------------------------------------------------------------------------------                                                       
      #ifdef WIN32                                                                                                                                       
      loadTexture("_MODEL_FOLDERS_/pillerPlantPot/pillerPlantPot_HEIGHT.png",          pillerPlantPot_HEIGHT);          
      loadTexture("_MODEL_FOLDERS_/pillerPlantPot/pillerPlantPot_DOT3.png",          pillerPlantPot_NORMALMAP);                
