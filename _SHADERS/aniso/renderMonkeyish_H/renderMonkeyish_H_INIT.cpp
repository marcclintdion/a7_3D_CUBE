...
*/
      ...
      //"         Reflect               =  reflect(invertView, normalFrag);                                                                                                 \n"
      ...
      "         ColorTex                   =  texture2D(Texture1,  varTexcoord);                                                  \n"        
      ...
      //========================================================================================================
      "         highp vec3 tang                  =  tanA * highp vec3(normalFrag.z*2.86, normalFrag.y*3.41, normalFrag.x*shininess) + sinA * highp vec3(normalFrag.x*attenuation, normalFrag.y*3.41, normalFrag.z*2.86);  \n"  //!var         renderMonkeyish_H_ATTENUATION    =  1.057;var         renderMonkeyish_H_SHININESS    =  205.001;var         renderMonkeyish_H_NOISE_SCALE      =  -0.0034;
      ...
      "         vec4 color_Velvet          =   color * NdotL1 * NdotL1 * 0.377001                    \n"  
      "                                    +   gloss * specular;                                                                           \n"                    



      "         gl_FragColor = color_Velvet;                   \n"
      ...
      UNIFORM_MODELVIEW_renderMonkeyish_H                       = glGetUniformLocation(renderMonkeyish_H_SHADER,   "modelView");                                                    
      ...
      UNIFORM_FRESNEL_renderMonkeyish_H                         = glGetUniformLocation(renderMonkeyish_H_SHADER,   "FresnelMap"); 

      #ifdef WIN32  
      loadTexture("_SHADERS/aniso/cornerStone_FRa.png",                renderMonkeyish_H_FRESNEL);       
      #endif 
