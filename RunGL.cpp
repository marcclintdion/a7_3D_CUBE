...
void setupTransforms_Shadows(void)
{
        ...
        Translate(LightModelViewMatrix,  eyeposition_SHADOW[0] ,
                                         eyeposition_SHADOW[1] ,
                                         eyeposition_SHADOW[2]);
        //----------------------------------------------------
        Rotate(LightModelViewMatrix, 0.0, 1.0, 0.0, turnTable);
        Rotate(LightModelViewMatrix, 1.0, 0.0, 0.0, audioRotation[3]);     
        //=============================================================================================================
        AssignMatrix(modelViewShadow, LightModelViewMatrix);
        //=============================================================================================================
        Translate(LightModelViewMatrix, moveSet[0]  , moveSet[1] , moveSet[2] );
...
//====================================================================================
       ...
       shaderNumber = 70;
        setupTransforms_MainColor();
        //==========================        
        Translate(modelView, 16.0, 0.0, 0.0);
//====================================================================================
#include "_MODEL_FOLDERS_/floorTile_2m/BATCH_A/floorTile_2m_BATCH_A_RENDER.cpp"
//------------------------------------------------------------------------------
        //====================================================================================
...
//====================================================================================
        ...
        setupTransforms_MainColor();
        //==========================        
        Translate(modelView, 16.0, 0.0, -2.0);
//====================================================================================
#include "_MODEL_FOLDERS_/floorTile_2m/BATCH_A/floorTile_2m_BATCH_A_RENDER.cpp"
        //====================================================================================
        shaderNumber = 70;
...
void ProcessKeyboard(void)
{
    ...
    {
             leaves_A_LIGHT_POSITION_01[0]         +=  1.011;
    }
    ...
    {
             leaves_A_LIGHT_POSITION_01[1]         += 1.011;
    } 
    ...
    {
             leaves_A_LIGHT_POSITION_01[2]         +=  1.011;
    }
    ...
    if(keys[VK_F8] && !keys[VK_SHIFT] && !keys[VK_CONTROL])
    {
         ...
         //------------------------------------------------------------------------------------------------------------------------------
         outSettings << "var         leaves_A_LIGHT_POSITION_01[]    =  {"   
                                  << leaves_A_LIGHT_POSITION_01[0] << ", "
